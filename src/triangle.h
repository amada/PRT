...
SoaTriangleIntersection intersectTriangle(const SoaMask& mask, const SoaVector3f& org, const SoaVector3f& dir, const SoaMask& maskX, const SoaMask& maskY, const SoaVector3f& v0, const SoaVector3f& v1, const SoaVector3f& v2);
